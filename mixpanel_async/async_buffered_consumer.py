...
class AsyncBufferedConsumer(SynchronousBufferedConsumer):
    ...
    flush(asynchronous=False) before you terminate any process where you have
    been using the AsyncBufferedConsumer.
    '''
    ...
    def flush(self, endpoint=None, asynchronous=True):
        '''
        ...
        for sending the data
        :param asynchronous (bool): Whether to flush the data in a seperate thread or not
        '''
    ...
    def _flush_endpoint(self, endpoint, asynchronous=True):
        ...
        self.flush(endpoint=endpoint, asynchronous=asynchronous)
